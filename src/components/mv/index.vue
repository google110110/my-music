...
<div class="warper">
    <div class="box">
        <div class="table">MV推荐 <span @click="getrout('/recommend/leaderboard')">返回</span></div>
        <div class="mv">
...
import videoComponents from '@/components/videoComponents'
    export default {
        ...
        methods:{
            getdata(pages,num) {
                // https://autumnfish.cn/top/mv?offset=-1&limit=10
                this.flag = false
                api.api(`/top/mv?offset=${pages}&limit=${num}`, `mvlistpages${pages}`).then(data => {
                    if(data.code == 200){
